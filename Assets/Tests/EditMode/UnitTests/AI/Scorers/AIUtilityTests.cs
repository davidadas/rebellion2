...
namespace Rebellion.Tests.AI.Scorers
{
    ...
    public class AIUtilityTests
    {
        ...
        [Test]
        public void Fulfillment_WithConfiguredSaturation_ReturnsNormalizedValue()
        {
            GameConfig.AIConsiderationConfig consideration = new GameConfig.AIConsiderationConfig
            {
                SaturationValue = 20,
            ...
            Assert.That(AIUtility.Fulfillment(5, consideration), Is.EqualTo(0.25).Within(0.000001));
        }
    }
}
