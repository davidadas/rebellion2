...
namespace Rebellion.Tests.Simulation.MessagesTests
{
    [TestFixture]
    public class MessagesTests
    {
        ...
        [Test]
        public void HandleCommands_WithCombatReport_DeliversReportAsMessage()
        {
            ...
            DeliverMessageCommand request = new DeliverMessageCommand
            {
                Recipient = faction,
            ...
            Messages messageSystem = new Messages(game, new List<MessageDefinition>());

            List<GameResult> results = messageSystem.HandleCommands(new[] { request });
