...
namespace Rebellion.Tests.Simulation.GalaxyTests
{
    ...
    public class BlockadesTests
    {
        ...
        public void RollEvacuationLoss_RollBelowThreshold_ReturnsTrue()
        {
            ...
            Blockades system = new Blockades(game, new FixedRNG());
        ...
        public void RollEvacuationLoss_RollAboveThreshold_ReturnsFalse()
        {
            ...
            Blockades system = new Blockades(game, new MaximumRNG());
