...
namespace Rebellion.Tests.Simulation.GalaxyTests
{
    ...
    public class UprisingsTests
    {
        ...
        public void ProcessTick_SufficientGarrison_NoUprising()
        {
            ...
            (GameRoot game, Planet planet, Uprisings system) = BuildScene(
                ownerSupport: 10,
                troopCount: 5
            );
        ...
        public void ProcessTick_NoGarrison_UprisingStarts()
        {
            ...
            Assert.AreEqual(
                ...
                "Uprisings must not change ownership"
            );
        ...
        public void ProcessTick_NeutralPlanet_Skipped()
        {
            ...
            Movement movementSystem = new Movement(game, new FogOfWar(game), new Fleets(game));
            ...
            Uprisings uprisingSystem = new Uprisings(game, new StubRNG(), planetaryControl);
        ...
        public void TryExecuteMission_OfficersOutOfScoreOrder_AttemptsLowestScoreFirst()
        {
            ...
            (GameRoot game, Planet planet, Uprisings system) = BuildScene(rng: rng);
        ...
        private (GameRoot game, Planet planet, Uprisings system) BuildScene(
            int ownerSupport = 10,
        ...
        )
        {
            ...
            Uprisings uprisingSystem = new Uprisings(game, rng ?? new StubRNG(), planetaryControl);
    ...
    public class GarrisonRequirementTests
    {
        ...
        )
        {
            ...
            int garrison = Uprisings.CalculateGarrisonRequirement(
                planet,
                faction,
                config.AI.Garrison
            );
