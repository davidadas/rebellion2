...
using SimulationManufacturing = Rebellion.Simulation.Manufacturing;
...
namespace Rebellion.Tests.Simulation.ManufacturingTests
{
    ...
    public class ManufacturingTests
    {
        ...
        private SimulationManufacturing _manager;
        private SimulationMovement _movement;
        ...
        public void SetUp()
        {
            ...
            _movement = new SimulationMovement(_game, new FogOfWar(_game), new Fleets(_game));
            _manager = new SimulationManufacturing(_game, new Fleets(_game), _movement);
        }
        ...
        public void Constructor_WithNullGame_ThrowsArgumentNullException()
        {
            ...
            ArgumentNullException exception = Assert.Throws<ArgumentNullException>(() =>
                new SimulationManufacturing(null, new Fleets(dependencyGame))
            );
        ...
        {
            ArgumentNullException exception = Assert.Throws<ArgumentNullException>(() =>
                new SimulationManufacturing(_game, null)
            );
        ...
        public void ProcessTick_EmptyGame_ReturnsNoResults()
        {
            ...
            SimulationManufacturing emptyManager = new SimulationManufacturing(
                emptyGame,
                new Fleets(emptyGame),
                new SimulationMovement(emptyGame, new FogOfWar(emptyGame), new Fleets(emptyGame))
            );
        ...
        public void ProcessTick_CapitalShipBuilding_RemainsInFleetWithProgress()
        {
            ...
            SimulationManufacturing mfg = new SimulationManufacturing(
                _game,
                new Fleets(_game),
                _movement
            );
        ...
        public void ProcessTick_CapitalShip_UsesEveryReadyFacilityWithoutConsumingMaterial()
        {
            ...
            SimulationManufacturing manufacturing = new SimulationManufacturing(
                game,
                fleetSystem,
                new SimulationMovement(game, new FogOfWar(game), fleetSystem)
            );
        ...
        public void ProcessTick_CapitalShipCompleteFleetOverHostilePlanet_ShipTravelsToFleet()
        {
            ...
            SimulationMovement localMovement = new SimulationMovement(
                _game,
                new FogOfWar(_game),
                new Fleets(_game)
            );
        ...
        public void ClearQueue_BuildingQueue_ClearsQueueAndQueuedDestinationBuildings()
        {
            ...
            SimulationManufacturing manager = new SimulationManufacturing(game, new Fleets(game));
        ...
        public void RebuildQueues_EmptyGame_NoQueues()
        {
            ...
            SimulationManufacturing _manager = new SimulationManufacturing(
                _game,
                new Fleets(_game)
            );
        ...
        public void RetargetManufacturingDestination_QueuedLane_MovesEveryItem()
        {
            ...
            Fleets fleetSystem = new Fleets(game);
            SimulationMovement movementSystem = new SimulationMovement(
                game,
                new FogOfWar(game),
                fleetSystem
            );
            SimulationManufacturing manager = new SimulationManufacturing(
                game,
                fleetSystem,
                movementSystem
            );
        ...
        public void EstimateManufacturingTicks_MixedFacilityRates_UsesIntegerRateShares()
        {
            ...
            int? estimate = SimulationManufacturing.EstimateManufacturingTicks(planet, template, 1);
        ...
        public void EstimateCompletionTicks_Default_IncludesEarlierQueuedWorkAndCurrentProgress()
        {
            ...
            int? estimate = SimulationManufacturing.EstimateCompletionTicks(planet, second);
        ...
        public void EstimateCompletionTicks_ActiveFacilityCycle_UsesRemainingCycleTime()
        {
            ...
            int? estimate = SimulationManufacturing.EstimateCompletionTicks(planet, item);
