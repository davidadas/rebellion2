...
namespace Rebellion.Tests.Simulation.OfficersTests
{
    ...
    public class DuelsTests
    {
        ...
        public void HandleResults_FailedAvoidance_CapturesEncounteredOfficer()
        {
            ...
            Duels system = new Duels(game, new FixedRandomProvider(new[] { 0.99, 0.99, 0.99 }));

            List<GameResult> results = system.HandleCommands(
        ...
        public void HandleResults_OfficersOnDifferentPlanets_RejectsDuel()
        {
            ...
            Duels system = new Duels(game, new FixedRandomProvider(new[] { 0.0 }));
        ...
        private static DuelCommand Request(
            Officer encountered,
            Officer opposing,
