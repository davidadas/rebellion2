...
{
    /// <summary>
    /// Tests for Jedi force discovery state and force user discovery scanning.
    /// </summary>
    [TestFixture]
    public class JediTests
    {
        private GameRoot _game;
        private Jedi _system;
        ...
        public void SetUp()
        {
            ...
            _system = new Jedi(_game, new FixedRNG());
        ...
        public void ProcessTick_DiscoveringJediWithDormantCandidate_DiscoversDormant()
        {
            ...
            _system = new Jedi(_game, new FixedRNG(0.0));
            List<ForceDiscoveryResult> results = _system
                .ProcessTick()
                .OfType<ForceDiscoveryResult>()
        ...
        public void ProcessTick_HighRoll_DiscoveryFails()
        {
            ...
            _system = new Jedi(_game, new MaximumRNG());
            List<ForceDiscoveryResult> results = _system
                .ProcessTick()
                .OfType<ForceDiscoveryResult>()
                .Where(r => r.EventType == ForceEventType.ForceUserDiscovered)
        ...
        /// <summary>
        /// Creates jedi trainer.
        /// </summary>
        /// <param name="id">The id.</param>
        /// <param name="forceValue">The force value.</param>
        /// <returns>The created jedi trainer.</returns>
        ...
        /// <param name="id">The id.</param>
        /// <param name="forceValue">The force value.</param>
        /// <returns>The created known jedi.</returns>
        ...
        /// <summary>
        /// Creates dormant jedi.
        /// </summary>
        /// <param name="id">The id.</param>
        /// <returns>The created dormant jedi.</returns>
