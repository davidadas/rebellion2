...
{
    [TestFixture]
    public class OfficerLoyaltyTests
    {
        [Test]
        public void HandleResults_FactionGainsPlanet_ShiftsOnlyFreeLivingOfficerLoyalty()
        {
            ...
            OfficerLoyalty system = new OfficerLoyalty(game, new SequenceRNG(new[] { 5 }));
        ...
        public void TryResolveMissionBetrayal_LowLoyaltyOfficer_FoilsWithoutRevealingIdentity()
        {
            ...
            bool betrayed = new OfficerLoyalty(game, new StubRNG()).TryResolveMissionBetrayal(
                mission,
        ...
        )
        {
            ...
            bool betrayed = new OfficerLoyalty(
                game,
