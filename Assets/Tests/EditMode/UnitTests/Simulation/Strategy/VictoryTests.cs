...
namespace Rebellion.Tests.Simulation.StrategyTests
{
    [TestFixture]
    public class VictoryTests
    {
        ...
        {
            (GameRoot game, Faction empire, _, _, Victory system) = BuildScene();
        ...
        {
            (_, _, _, _, Victory system) = BuildScene(rebelsCaptureEmpireHQ: false);
        ...
        {
            (_, Faction empire, Faction rebels, _, Victory system) = BuildScene(
        ...
        {
            (_, _, _, _, Victory system) = BuildScene();
        ...
        {
            (GameRoot game, Faction empire, Faction rebels, _, Victory system) = BuildScene(
                GameVictoryCondition.Conquest
            );
        ...
        {
            (_, _, Faction rebels, _, Victory system) = BuildScene(GameVictoryCondition.Conquest);
        ...
        {
            (GameRoot game, Faction empire, _, Planet empireHQ, Victory system) = BuildScene(
        ...
        {
            (_, Faction empire, _, _, Victory system) = BuildScene(rebelsCaptureEmpireHQ: false);
            empire.Settings = new FactionSettings
            {
                Headquarters = new HeadquartersSettings
                {
        ...
        {
            (GameRoot game, Faction empire, Faction rebels, Planet empireHQ, Victory system) =
        ...
        )
        {
            ...
            return (game, empire, rebels, empireHQ, new Victory(game));
        }
    }
}
