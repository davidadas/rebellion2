...
namespace Rebellion.Tests.Simulation.MovementTests
{
    [TestFixture]
    public class MovementTests
    {
        ...
        public void Constructor_WithNullGame_ThrowsArgumentNullException()
        {
            ...
            ArgumentNullException exception = Assert.Throws<ArgumentNullException>(() =>
                new Movement(null, new FogOfWar(dependencyGame), new Fleets(dependencyGame))
            );
        ...
        public void Constructor_WithNullFogOfWar_ThrowsArgumentNullException()
        {
            ...
            ArgumentNullException exception = Assert.Throws<ArgumentNullException>(() =>
                new Movement(game, null, new Fleets(game))
            );
        ...
        public void Constructor_WithNullFleetSystem_ThrowsArgumentNullException()
        {
            ...
            ArgumentNullException exception = Assert.Throws<ArgumentNullException>(() =>
                new Movement(game, new FogOfWar(game), null)
            );
        ...
        {
            (GameRoot game, Planet origin, Planet destination, Officer officer, Movement movement) =
                BuildScene();
        ...
        {
            (GameRoot game, Planet origin, Planet _, Officer officer, Movement movement) =
                BuildScene();
        ...
        {
            (GameRoot game, Planet origin, Planet destination, Officer escort, Movement movement) =
                BuildScene();
        ...
        {
            (GameRoot game, Planet origin, Planet destination, Officer _, Movement movement) =
                BuildScene();
        ...
        public void RequestMove_StarfighterUnderConstruction_RetargetsDestination()
        {
            ...
            Movement movement = new Movement(game, new FogOfWar(game), new Fleets(game));
            Manufacturing mfg = new Manufacturing(game, new Fleets(game));
        ...
        public void RequestMove_ManufacturedBuildingCompletedAtBlockadedProductionPlanet_RemainsLocal()
        {
            (
                ...
                Blockades blockade,
                Movement movement,
                ResultReactions resultProcessor
        ...
        public void RequestMove_RegimentFromBlockadedPlanet_LowRoll_DestroysRegiment()
        {
            ...
            (GameRoot game, Planet origin, Planet destination, Movement movement) =
        ...
        public void RequestMove_RegimentFromUnblockedPlanet_NoEvacuationLoss()
        {
            ...
            Blockades blockade = new Blockades(game, new FixedRNG());
            Movement movement = new Movement(game, new FogOfWar(game), new Fleets(game), blockade);
        ...
        {
            (GameRoot game, _, Planet destination, Officer officer, Movement movement) =
                BuildScene();
            IGameCommandHandler<MoveUnitsCommand> handler = movement;
        ...
        {
            (_, _, Planet destination, Officer officer, Movement movement) = BuildScene();
            IGameCommandHandler<MoveUnitsCommand> handler = movement;
            handler.HandleCommands(
                new[]
                {
        ...
        {
            (_, Planet origin, _, Officer officer, Movement movement) = BuildScene();
            IGameCommandHandler<MoveUnitsCommand> handler = movement;

            List<GameResult> results = handler.HandleCommands(
                new[]
                {
                    new MoveUnitsCommand
                    {
        ...
        /// <summary>
        /// Handles placement request new detached unit attaches and registers unit.
        /// </summary>
        public void HandlePlacementRequest_NewDetachedUnit_AttachesAndRegistersUnit()
        {
            (GameRoot game, _, Planet destination, _, Movement movement) = BuildScene();
            Regiment regiment = new Regiment
            {
            ...
            IGameCommandHandler<PlaceUnitsCommand> handler = movement;
        ...
        {
            (GameRoot game, Planet origin, Planet destination, _, Movement movement) = BuildScene();
        ...
        public void UpdateMovement_BlockadeEndsBeforeManufacturedBuildingArrival_CompletesArrival()
        {
            ...
            scene.resultProcessor.Resolve(scene.blockade.ProcessTick());
        ...
        {
            (_, Planet origin, Planet firstDestination, _, Fleet fleet, Movement movement) =
                BuildWaypointScene();
        ...
        {
            (GameRoot game, Planet origin, Planet _, Officer _, Movement movement) = BuildScene();
            Regiment regiment = new Regiment
            {
                InstanceID = "garrison-reg",
                OwnerInstanceID = "empire",
        ...
        // the origin planet, and a Movement ready to use.
        /// <summary>
        /// Builds scene.
        /// </summary>
        ...
        ) BuildBlockadeRetargetingScene()
        {
            ...
            Blockades blockade = new Blockades(game, new FixedRNG());
            Movement movement = new Movement(game, new FogOfWar(game), new Fleets(game), blockade);
            ResultReactions resultProcessor = new ResultReactions();
        ...
        {
            return resultProcessor.Resolve(blockade.ProcessTick());
        }
        ...
        ) BuildBlockadeScene(IRandomNumberProvider rng)
        {
            ...
            Blockades blockade = new Blockades(game, rng);
            Movement movement = new Movement(game, new FogOfWar(game), new Fleets(game), blockade);
        ...
        )
        {
            ...
            new FogOfWar(game).CaptureSnapshot(faction, planet, sector, tick);
        }
