...
namespace Rebellion.Tests.Simulation.CombatTests
{
    ...
    /// </summary>
    [TestFixture]
    public class SpaceCombatTests : CombatTestBase
    {
        [Test]
        public void Resolve_TwoFactionFleets_RunsSpaceCombat()
        {
            ...
            SpaceCombat manager = MakeSpaceCombat(game);
        ...
        private bool RunCombat(SpaceCombat manager)
        {
        ...
        /// <returns>True when the operation succeeds; otherwise false.</returns>
        private bool TryRunCombat(SpaceCombat manager, out List<GameResult> results)
        {
