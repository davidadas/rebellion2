...
namespace Rebellion.Tests.Simulation
{
    ...
    public sealed class GameSessionTests
    {
        ...
        public void ResolveCombat_DestroyedDefenderAfterAttackerLeaves_DoesNotRestoreSnapshotGhost()
        {
            ...
            SpaceCombatResult result = manager.Tick.ResolveCombat(autoResolve: true);
            game.MoveNode(attacker, origin);
            GalaxyMap view = fogQueries.BuildFactionView(alliance);
            ...
            Assert.IsFalse(fogQueries.IsPlanetVisible(battlePlanet, alliance));
            Assert.IsFalse(
