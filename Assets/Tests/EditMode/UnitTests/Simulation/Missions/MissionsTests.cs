...
namespace Rebellion.Tests.Simulation.MissionsTests
{
    [TestFixture]
    public class MissionsTests
    {
        ...
        {
            (GameRoot game, Planet planet, Officer officer, Movement movement) = BuildScene(
            ...
            mission.Initiate(0);
            Missions system = TestSystems.CreateMissionSystem(game, new StubRNG(), movement);
        ...
        public void UpdateMission_CompletedWithoutReturnDestination_CapturesOfficerAndDetachesMission()
        {
            ...
            Missions missionSystem = TestSystems.CreateMissionSystem(game, new StubRNG(), movement);
        ...
        public void UpdateMission_MissingOwnerFaction_DetachesMission()
        {
            ...
            Movement movement = new Movement(game, new FogOfWar(game), new Fleets(game));
            Missions missionSystem = TestSystems.CreateMissionSystem(game, new StubRNG(), movement);
        ...
        public void UpdateMission_DiplomacyCompletionFromFleet_ParticipantRemainsAtTargetPlanet()
        {
            ...
            Movement movement = new Movement(game, new FogOfWar(game), new Fleets(game));
            Missions missions = TestSystems.CreateMissionSystem(game, new FixedRNG(0), movement);
        ...
        {
            (GameRoot game, Planet planet, Officer spy, Officer defender, Movement movement) =
                BuildDetectionScene();
            Officer traveler = new Officer
            {
                InstanceID = "o2",
            ...
            Missions system = TestSystems.CreateMissionSystem(game, new FixedRNG(0.01), movement);
        ...
        public void UpdateMission_DetectionRollFails_MissionContinues()
        {
            ...
            Missions system = TestSystems.CreateMissionSystem(game, new FixedRNG(0.99), movement);
        ...
        {
            (GameRoot game, Planet planet, Officer spy, Officer _, Movement movement) =
                BuildDetectionScene();
        ...
        {
            (GameRoot game, Planet planet, Officer firstOfficer, Officer _, Movement movement) =
                BuildDetectionScene();
        ...
        {
            (GameRoot game, Planet _, Planet target, Officer diplomat, Missions missions) =
        ...
        {
            (GameRoot game, Planet origin, Planet target, Officer _, Missions missions) =
        ...
        {
            (GameRoot game, Planet _, Planet targetPlanet, Officer attacker, Missions missions) =
                BuildMissionOddsScene("rebels");
        ...
        {
            (GameRoot game, Planet planet, Officer diplomat, Officer _, Movement movement) =
                BuildDetectionScene();
            planet.OwnerInstanceID = null;
            planet.PopularSupport["empire"] = 50;
            planet.AddVisitor("empire");
        ...
        {
            (GameRoot game, Planet planet, Officer recruiter, Officer _, Movement movement) =
                BuildDetectionScene();
        ...
        {
            (GameRoot game, Planet planet, Officer spy, Officer general, Movement movement) =
                BuildDetectionScene();
            ...
            Missions system = TestSystems.CreateMissionSystem(game, new FixedRNG(0.0), movement);
        ...
        {
            (GameRoot game, Planet planet, Officer spy, CapitalShip captorShip, Movement movement) =
        ...
        {
            (GameRoot game, Planet planet, Officer spy, Movement movement) = BuildScene(
                factionOwnsPlanet: true
            );
        ...
        {
            (GameRoot game, Planet missionPlanet, Officer officer, Movement movement) = BuildScene(
                factionOwnsPlanet: true
            );
        ...
        {
            (GameRoot game, Planet planet, Officer participant, Movement movement) = BuildScene(
                factionOwnsPlanet: true
            );
        ...
        {
            (GameRoot game, Planet origin, Officer officer, Movement movement) = BuildScene(
                factionOwnsPlanet: true
            );
        ...
        {
            (GameRoot game, Planet planetA, Officer officer, Movement movement) = BuildScene(
                factionOwnsPlanet: true
            );
            game.GetFactions().Add(new Faction { InstanceID = "rebels" });
        ...
        {
            (GameRoot game, Planet planet, Officer firstOfficer, Movement movement) = BuildScene(
                factionOwnsPlanet: true
            );
        ...
        public void InitiateMission_ExhaustedResearch_ReturnsFalse()
        {
            ...
            Missions missions = TestSystems.CreateMissionSystem(game, new StubRNG(), movement);
        ...
        {
            (GameRoot game, Planet planet, Officer trainer, Movement movement) = BuildScene(
                factionOwnsPlanet: true
            );
            ...
            Missions system = TestSystems.CreateMissionSystem(
                game,
        ...
        private (GameRoot game, Planet planet, Officer officer, Movement movement) BuildScene(
        ...
        ) BuildOfficerTargetMissionScene(bool friendlyTarget, bool capturedTarget)
        {
            ...
            Movement movement = new Movement(game, new FogOfWar(game), new Fleets(game));
            Missions missions = TestSystems.CreateMissionSystem(game, new FixedRNG(0.0), movement);
        ...
        ) BuildConcurrentMissionsScene(int ownerSupport = 50, bool hasGarrison = true)
        {
            ...
            Missions missionSystem = new Missions(game, rng, movement, uprising);
