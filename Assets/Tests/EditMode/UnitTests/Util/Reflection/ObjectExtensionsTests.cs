...
namespace Rebellion.Tests.Util.Reflection
{
    ...
    public class TestClassWithPrivateSetters
    {
        ...
        /// <summary>
        /// Initializes a new instance of the TestClassWithPrivateSetters class.
        /// </summary>
        ...
        /// </summary>
        /// <returns>The requested private property.</returns>
    ...
    public class TestClassWithoutDefaultConstructor
    {
        ...
        /// <summary>
        /// Initializes a new instance of the TestClassWithoutDefaultConstructor class.
        /// </summary>
        /// <param name="value">The value.</param>
    ...
    public class GenericTestClass<T1, T2>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the GenericTestClass class.
        /// </summary>
    ...
    public class ObjectExtensionsTests
    {
        ...
        public void GetDeepCopy_ArrayProperties_AreDeeplyCopied()
        {
            ...
            for (int i = 0; i < original.ObjectArray.Length; i++)
            {
                ...
                Assert.AreEqual(
                    original.ObjectArray[i].IntProperty,
                    copy.ObjectArray[i].IntProperty
                );
                Assert.AreEqual(
        ...
        public void GetDeepCopy_ClassWithStruct_IsDeeplyCopied()
        {
            ClassWithStruct original = new ClassWithStruct
            {
                StructProperty = new StructWithReferenceTypes
                {
                    IntValue = 42,
                    StringValue = "Hello",
                    ObjectValue = new SimpleTestClass
                    {
                        IntProperty = 10,
        ...
        {
            TestClassWithoutDefaultConstructor original = new TestClassWithoutDefaultConstructor(
                42
            );
