...
namespace Rebellion.Tests.Util.Serialization
{
    ...
    public class SimpleItem : ITestItem
    {
        ...
        /// <summary>
        /// Initializes a new instance of the SimpleItem class.
        /// </summary>
        public SimpleItem() { }
    }
    ...
    public class NestedItem
    {
        ...
        /// <summary>
        /// Initializes a new instance of the NestedItem class.
        /// </summary>
        public NestedItem()
        {
    ...
    public class DeeplyNestedItem
    {
        ...
        /// <summary>
        /// Initializes a new instance of the DeeplyNestedItem class.
        /// </summary>
    ...
    public class InterfaceCollection
    {
        ...
        /// <summary>
        /// Initializes a new instance of the InterfaceCollection class.
        /// </summary>
    ...
    public class SimpleItemWithDictionary
    {
        ...
        /// <summary>
        /// Initializes a new instance of the SimpleItemWithDictionary class.
        /// </summary>
    ...
    public class ComplexItemWithDictionary
    {
        ...
        /// <summary>
        /// Initializes a new instance of the ComplexItemWithDictionary class.
        /// </summary>
    ...
    public class ItemWithAttributes
    {
        ...
        /// <summary>
        /// Initializes a new instance of the ItemWithAttributes class.
        /// </summary>
    ...
    public class ItemWithCustomName
    {
        ...
        /// <summary>
        /// Initializes a new instance of the ItemWithCustomName class.
        /// </summary>
    ...
    public class ItemWithInclude
    {
        ...
        /// <summary>
        /// Initializes a new instance of the ItemWithInclude class.
        /// </summary>
...
<SimpleItem>
  ...
  <PublicVariable>PublicValue</PublicVariable>
        ...
        public void Serialize_NestedItem_IgnoresIgnoredPublicVariables()
        {
            ...
            Assert.IsTrue(
                serializedXml.Contains("<PublicVariable>NestedPublicValue</PublicVariable>")
            );
...
<InterfaceCollection>
  ...
  <PublicVariable>CollectionPublicValue</PublicVariable>
        ...
        public void Serialize_NestedItem_WithInterfaceAndDeeplyNested_ReturnsExpectedXml()
        {
            ...
            Assert.IsTrue(
                serializedXml.Contains("<PublicVariable>DeepPublicValue</PublicVariable>")
            );
            Assert.IsTrue(
                serializedXml.Contains("<PublicVariable>NestedPublicValue</PublicVariable>")
            );
...
<DeeplyNestedItem>
  ...
  <PublicVariable>DeepPublicValue</PublicVariable>
            ...
            Assert.AreEqual(
                "SimplePublicValue1",
                deserialized.NestedItems[0].Items[0].PublicVariable
            );
        }
      ...
      <Value>
        <SimpleItem>
          ...
          <PublicVariable>PublicValue2</PublicVariable>
            ...
            ComplexItemWithDictionary deserialized =
                (ComplexItemWithDictionary)DeserializeFromString(serializer, xmlInput);
            ...
            Assert.AreEqual(
                "PublicValue1",
                deserialized.StringObjectDict["ObjectKey1"].PublicVariable
            );
...
<ItemWithInclude>
  <SimpleItem>
    ...
    <Value>42</Value>
            ...
            ItemWithInclude deserialized = (ItemWithInclude)DeserializeFromString(
                serializer,
                xmlInput
            );
...
<SimpleItem>
  ...
  <Value>0</Value>
        ...
        /// <summary>
        /// Builds simple item schema.
        /// </summary>
        /// <returns>The constructed simple item schema.</returns>
  ...
  <xs:element name=""SimpleItem"">
    <xs:complexType>
      ...
      <xs:attribute name=""AttributeVariable"" type=""xs:string""/>
        ...
        /// <returns>The result of serialize to string.</returns>
        ...
        /// <returns>The result of deserialize from string.</returns>
