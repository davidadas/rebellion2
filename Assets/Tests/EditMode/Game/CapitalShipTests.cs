...
public class CapitalShipTests
{
    ...
    public void TestAddOfficerInvalidOwner()
    {
        ...
        Officer officer = new Officer { OwnerGameID = "INVALID" };
    ...
    public void TestSerializeAndDeserialize()
    {
        ...
        Assert.AreEqual(capitalShip.OwnerGameID, deserialized.OwnerGameID, "OwnerGameID should be correctly deserialized.");
