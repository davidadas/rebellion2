...
namespace Rebellion.Tests.AI.Combat
{
    ...
    {
        [Test]
        public void ShouldRetreat_OutmatchedFleet_ReturnsTrue()
        {
            ...
            bool shouldRetreat = policy.ShouldRetreat(fleet, planet, 100, 1000);

            Assert.IsTrue(shouldRetreat);
        }

        [Test]
        public void ShouldRetreat_FixedHeadquartersDefender_ReturnsFalse()
        {
            (AISpaceCombatPolicy policy, Fleet fleet, Planet planet, GameRoot _) = CreateScenario(
                isHeadquarters: true,
                isMobile: false
            ...
            Assert.IsFalse(shouldRetreat);
        }

        [Test]
        public void ShouldRetreat_MobileHeadquartersDefender_ReturnsTrue()
        {
            (AISpaceCombatPolicy policy, Fleet fleet, Planet planet, GameRoot _) = CreateScenario(
                isHeadquarters: true,
                isMobile: true
        ...
        [Test]
        public void ShouldRetreat_CapturedFixedHeadquartersDefender_ReturnsFalse()
        {
