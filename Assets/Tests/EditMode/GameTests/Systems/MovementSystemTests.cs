...
namespace Rebellion.Tests.Sectors
{
    ...
    public class MovementSystemTests
    {
        ...
        public void RequestMove_DifferentSystemDestination_UsesGlobalTransitMinimum()
        {
            ...
            PlanetSector originSystem = new PlanetSector { InstanceID = "sys1" };
            ...
            PlanetSector destinationSystem = new PlanetSector { InstanceID = "sys2" };
        ...
        public void ReturnFromMission_ParticipantsWithDifferentOrigins_ReturnToTheirOwnLocations()
        {
            ...
            PlanetSector secondSystem = new PlanetSector
            {
                InstanceID = "sys2",
                PositionX = 200,
                PositionY = 0,
        ...
        public void BlockadeStarted_NearerFriendlyCarrier_IsPreferredOverOwnedPlanet()
        {
            ...
            PlanetSector system = scene.blockadedDestination.GetParentOfType<PlanetSector>();
