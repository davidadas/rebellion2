...
namespace Rebellion.Tests.AI.Director
{
    ...
    public class AIAssessmentTests
    {
        ...
        public void GetRequiredHeadquartersDefenseStrength_WithRemoteHeadquartersAttack_UsesThreatStrength()
        {
            ...
            Assert.AreEqual(2500, assessment.GetRequiredHeadquartersDefenseStrength(headquarters));
        }

        [Test]
        public void CanFleetDepartHeadquarters_AtCapturedEnemyHeadquarters_ReturnsTrue()
        {
            GameRoot game = AITestSceneBuilder.CreateGame(out Faction empire, out Faction rebels);
            PlanetSystem system = AITestSceneBuilder.AddSystem(game, "sys1");
            Planet headquarters = AITestSceneBuilder.AddPlanet(
        ...
        public void IsFleetReadyToAttack_ShieldedTarget_RequiresShieldPenetration()
        {
            ...
            game.AttachNode(bomber, readyFleet.CapitalShips.Single());
        ...
        [Test]
        public void GetRequiredAttackRegimentCount_WithDefendersAndLowSupport_IncludesStableGarrison()
        {
            GameRoot game = AITestSceneBuilder.CreateGame(out Faction empire, out Faction rebels);
