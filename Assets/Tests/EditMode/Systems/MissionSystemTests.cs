...
namespace Rebellion.Tests.Systems
{
    ...
    public class MissionSystemTests
    {
        ...
        [Test]
        public void BetrayalSystem_LowLoyaltyOfficer_FoilsMissionWithoutRevealingIdentity()
        {
        ...
        [Test]
        public void BetrayalSystem_ForceCapableCompanion_DiscoversTraitor()
        {
            (GameRoot game, Planet planet, Officer traitor, _) = BuildScene(
                factionOwnsPlanet: true
            );
        ...
        [Test]
        public void BetrayalSystem_FactionGainsPlanet_ShiftsOnlyFreeLivingOfficerLoyalty()
        {
            (GameRoot game, Planet planet, Officer empireOfficer, _) = BuildScene(
                factionOwnsPlanet: true
            );
        ...
        public void BetrayalSystem_BetrayalProbability_IsOneHundredMinusLoyalty(
            int loyalty,
            int roll,
        ...
        [Test]
        public void BetrayalSystem_CommandOfficer_CannotBetrayMission()
        {
            (GameRoot game, Planet planet, Officer officer, _) = BuildScene(
                factionOwnsPlanet: true
            );
