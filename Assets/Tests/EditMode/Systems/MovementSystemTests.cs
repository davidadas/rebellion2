...
namespace Rebellion.Tests.Systems
{
    ...
    public class MovementSystemTests
    {
        ...
        ) BuildFleetWithInTransitChildrenScene()
        {
            ...
            return (game, movement, fleet, cs1, cs2, sf, reg, officer, planetA, planetB, planetC, fleetTransit, cs2Transit);
        }
        ...
        public void UpdateMovement_InTransitFleetWithInTransitChildren_FleetArrivesBeforeChildren()
        {
            ...
            Assert.IsNotNull(scene.cs2.Movement, "CS2 should still be in transit while fleet has arrived.");

            // Verify fleet children are intact.
            Assert.AreEqual(scene.fleet, scene.cs1.GetParent(), "CS1 should still be in the fleet.");
            ...
            Assert.AreEqual(scene.fleet, scene.officer.GetParent());
        }
        ...
        public void UpdateMovement_InTransitFleetWithInTransitChildren_ChildrenArriveAfterFleet()
        {
            ...
            Assert.AreEqual(scene.planetB, scene.fleet.GetParent(), "Fleet should still be at planet B.");
        }
        ...
        public void RequestMove_UnitUnderConstruction_IsNotMoved()
        {
            ...
            Assert.IsNull(fighter.Movement, "Fighter should have no movement state while under construction.");
        }
        ...
        public void RequestMove_CapitalShipToFleet_LandsAtFleet()
        {
            ...
            // With default GameConfig (DistanceScale = 0), transit completes in one tick.
            movement.ProcessTick();

            Assert.IsNull(cs.Movement, "Capital ship should have no movement state after arrival.");
            Assert.AreEqual(fleet, cs.GetParent(), "Capital ship should be in the destination fleet.");
