...
namespace Rebellion.Tests.Systems
{
    ...
    public class ResourceProductionSystemTests
    {
        ...
        [Test]
        public void ProcessTick_FactionWithUnitMaintenance_DoesNotDeductFromRefinedStockpile()
        {
            AddCompleteBuilding(_planet, BuildingType.Mine);
            AddCompleteBuilding(_planet, BuildingType.Refinery);
            ...
            int multiplier = _empire.Settings.RefinementMultiplier;
            Assert.AreEqual(1 * multiplier, afterSecondTick);
        }
