...
// //         SerializableDictionary<string, object> parameters = new SerializableDictionary<string, object>
// //         {
...
// //         SerializableDictionary<string, object> samePlanetParams = new SerializableDictionary<string, object> { { "UnitInstanceIDs", new List<string> { "LUKE_SKYWALKER", "DARTH_VADER" } } };
// //         SerializableDictionary<string, object> opposingFactionsParams = new SerializableDictionary<string, object> { { "UnitInstanceIDs", new List<string> { "LUKE_SKYWALKER", "HAN_SOLO" } } };
...
// //         SerializableDictionary<string, object> andParameters = new SerializableDictionary<string, object>
// //         {
...
// //         SerializableDictionary<string, object> orParameters = new SerializableDictionary<string, object>
// //         {
// //             { "Conditionals", new List<GameConditional> { samePlanetConditional, opposingFactionsConditional } }
// //         };
...
// //         SerializableDictionary<string, object> notParameters = new SerializableDictionary<string, object>
// //         {
...
// //     // public void TestNotConditional()
// //     // {
// //     //     var innerParameters = new SerializableDictionary<string, object>();
...
// //         SerializableDictionary<string, object> xorParameters = new SerializableDictionary<string, object>
// //         {
// //             { "Conditionals", new List<GameConditional> { samePlanetConditional, opposingFactionsConditional } }
// //         };
...
//         SerializableDictionary<string, object> samePlanetParams = new SerializableDictionary<string, object> 
//         { 
//             { "UnitInstanceIDs", new List<string> { "LUKE_SKYWALKER", "HAN_SOLO" } } 
//         };
...
//         SerializableDictionary<string, object> andParams = new SerializableDictionary<string, object> 
//         { 
