...
public static class StrategyViewPrefabBuilder
{
    ...
    private const string _missionsParticipantRowPrefabPath =
        "Assets/Prefabs/UI/StrategyView/MissionsParticipantRow.prefab";
    ...
    private const string _missionCreateParticipantRowPrefabPath =
        "Assets/Prefabs/UI/StrategyView/MissionCreateParticipantRow.prefab";
    ...
    {
        RebuildAllStrategyViewPrefabs(true);
    }
    ...
    public static void RebuildAllStrategyViewPrefabs(bool rebuildSharedControls)
    {
        UIAuthoringGuard.EnsureEditMode();
        _previewThemes = null;
