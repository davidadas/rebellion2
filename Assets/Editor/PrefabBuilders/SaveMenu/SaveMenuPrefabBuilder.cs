...
public static class SaveMenuPrefabBuilder
{
    ...
    /// <summary>
    /// Makes the save-name label fill the input vertically. TMP builds its caret from this exact
    /// rectangle, so using the same centered geometry for the label and placeholder keeps the
    /// blinking caret on the text line.
    /// </summary>
