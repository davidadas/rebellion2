...
public static class MainMenuPrefabBuilder
{
    ...
    private const string _cutscenePlayerPrefabPath =
        "Assets/Prefabs/UI/Cutscenes/CutscenePlayer.prefab";
    private const string _creditsVideoPath = "Assets/Resources/Videos/credits.mp4";
    ...
    private const string _selectSfxPath = "Audio/SFX/MainMenu/sfx_ui_mainmenu_select";
    private const string _exitSelectSfxPath = "Audio/SFX/MainMenu/sfx_ui_mainmenu_exit_select";
    ...
    private const string _planetModelPath = "Assets/Art/Models/MainMenu/planet.fbx";
    private const string _planetAlbedoPath = "Assets/Art/Models/MainMenu/planet_albedo.png";
    private const string _starfieldPath = "Assets/Art/Models/MainMenu/starfield.png";
    ...
    private const string _asteroidRingModelPath = "Assets/Art/Models/MainMenu/asteroid_ring.fbx";
    ...
    /// </summary>
    [MenuItem("Rebellion/Main Menu/Rebuild Main Menu Prefab")]
    ...
    private static void PopulateViewBindings(GameObject root, MainMenuView view)
    {
        ...
        serializedView.FindProperty("standardVictoryConditionSprite").objectReferenceValue =
            LoadSprite(-3367548231926181982, "428367c628bc64c7db52c0fdb8ef2692");
        serializedView.FindProperty("headquartersVictoryConditionSprite").objectReferenceValue =
            LoadSprite(4392630919389973362, "83f052424c114450487d6cd6b2d35386");
    ...
    private static void BuildServices(GameObject root)
    {
        ...
        GameObject cutsceneObject = NewChild("CutsceneManager", services.transform);
        CutsceneManager cutsceneManager = cutsceneObject.AddComponent<CutsceneManager>();
        AssignReference(
            cutsceneManager,
            "cutscenePrefab",
            LoadRequiredAsset<GameObject>(_cutscenePlayerPrefabPath).GetComponent<CutscenePlayer>()
        );
    }
    ...
    private static MainMenuController BuildController(GameObject root)
    {
        ...
        AssignReference(
            controller,
            "creditsClip",
            LoadRequiredAsset<UnityEngine.Video.VideoClip>(_creditsVideoPath)
        );
    ...
    private static void BuildCanvas(GameObject root)
    {
        ...
        cockpit.sprite = LoadSprite(9023254792070191278, "f490364cffda2491ab77de29ad9c0430");
    ...
    private static void BuildDifficultyGroup(Transform parent)
    {
        ...
        BuildDifficultyToggle(
            ...
            true,
            -3197665908956166884,
            "42e8a0914073347819fddfd503261e08",
        ...
        BuildDifficultyToggle(
            ...
            false,
            -4731054637686854587,
            "3518b89f0252a457c80d0a98e0f0015b",
        ...
        BuildDifficultyToggle(
            ...
            false,
            -4372513298435329126,
            "6853f102d90334702b9a7b65b45b8341",
    ...
    /// <param name="overlayFileId">The selection overlay sprite local file id.</param>
    /// <param name="overlayGuid">The selection overlay sprite guid.</param>
    ...
    )
    {
        ...
        overlay.sprite = LoadSprite(overlayFileId, overlayGuid);
    ...
    private static void BuildGalaxySizeGroup(Transform parent)
    {
        ...
        BuildGalaxySizeToggle(
            ...
            true,
            -4499967845820217543,
            "d2aef2e47e5f844e6bde4bafa4b181bf",
        ...
        BuildGalaxySizeToggle(
            ...
            false,
            -6531381471609559566,
            "1b89ae77e265f4358aa32c0c89136c1f",
        ...
        BuildGalaxySizeToggle(
            ...
            false,
            527639255941761311,
            "4e44333766dbd4edb8ec2cace65dd5fc",
    ...
    private static void BuildExitButton(Transform parent)
    {
        ...
        image.sprite = LoadSprite(-5923446240215283494, "f487870b265884d32ae11e06e2e54bd2");
        ...
        GameObject pressed = BuildPressedImage(
            ...
            7702443976129096025,
            "9705655b95c9f45c68e3e1d32c42fc0c"
        );
    ...
    private static void BuildCreditsButton(Transform parent)
    {
        ...
        Image image = buttonObject.GetComponent<Image>();
        image.sprite = LoadSprite(-1181595850936368484, "027d6e3dc22274d3191f2128aaab0f12");
        ...
        spriteState.pressedSprite = LoadSprite(
            -1738500102143540217,
            "9153f6f2db276425d8cdf7c4e0a19810"
        );
    ...
    private static void BuildLoadGameButton(Transform parent)
    {
        ...
        animator.runtimeAnimatorController = LoadRequiredAsset<RuntimeAnimatorController>(
            AssetDatabase.GUIDToAssetPath("7d4b33c965b5f4ac2b95060ba8f9a8e8")
        );

        Image image = buttonObject.GetComponent<Image>();
        image.sprite = LoadSprite(6256935228223071393, "102d95d45d76e440980b6dc4060e1bd5");
        ...
        BuildPressedImage(
            buttonObject.transform,
            6158112241636284914,
            "74ee868ef4778469da42df56e6448586"
        );
    ...
    /// <param name="spriteFileId">The pressed sprite local file id.</param>
    /// <param name="spriteGuid">The pressed sprite guid.</param>
    ...
    )
    {
        ...
        pressed.GetComponent<Image>().sprite = LoadSprite(spriteFileId, spriteGuid);
        return pressed;
    }
    ...
    private static void BuildVictoryConditionGroup(Transform parent)
    {
        ...
        icon.sprite = LoadSprite(4392630919389973362, "83f052424c114450487d6cd6b2d35386");
    ...
    /// <summary>
    /// Loads one sprite sub-asset by its serialized local file id and owning guid.
    /// </summary>
    /// <param name="fileId">The sprite local file identifier.</param>
    /// <param name="guid">The owning asset guid.</param>
    /// <returns>The matching sprite.</returns>
    private static Sprite LoadSprite(long fileId, string guid)
    {
        string path = AssetDatabase.GUIDToAssetPath(guid);
        if (string.IsNullOrEmpty(path))
            throw new FileNotFoundException($"No asset for guid {guid}.");
        ...
        return fallback ?? throw new FileNotFoundException($"No sprite {fileId} at {path}.");
    }
    ...
    private static void InstallPlanet(GameObject root)
    {
        ...
        RawImage stars = NewRawImage(backdrop.transform, "Starfield", starfield);
    ...
    private static void BuildPlanetRig(GameObject root, RenderTexture renderTexture)
    {
        ...
        GameObject model = AssetDatabase.LoadAssetAtPath<GameObject>(_planetModelPath);
        if (model == null)
            throw new InvalidOperationException($"Planet model not found at {_planetModelPath}.");

        GameObject instance = Object.Instantiate(model, pivot.transform);
        instance.name = "Model";
        instance.transform.localPosition = Vector3.zero;
        // Pole imports pointing up (pole-to-pole spin needs no tilt); 180 deg about it presents the
        // far side of the surface first.
        instance.transform.localRotation = Quaternion.Euler(0f, 180f, 0f);
        NormalizeToUnitDiameter(instance);
        CenterOnPivot(pivot.transform, instance);

        Material planetMaterial = LoadOrCreatePlanetMaterial();
        foreach (MeshRenderer meshRenderer in instance.GetComponentsInChildren<MeshRenderer>(true))
        {
            Material[] mats = new Material[Mathf.Max(1, meshRenderer.sharedMaterials.Length)];
            for (int m = 0; m < mats.Length; m++)
                mats[m] = planetMaterial;
            meshRenderer.sharedMaterials = mats;
        }

        // Put the planet on its own layer so its camera renders only it (spacing also isolates it).
        const int planetLayer = 31;
        SetLayerRecursively(instance, planetLayer);
        ...
        GameObject ringModel = AssetDatabase.LoadAssetAtPath<GameObject>(_asteroidRingModelPath);
        if (ringModel == null)
            throw new InvalidOperationException(
                $"Asteroid ring model not found at {_asteroidRingModelPath}."
            );
        GameObject ringInstance = Object.Instantiate(ringModel, ringOrbit.transform);
        ringInstance.name = "AsteroidRing";
        ringInstance.transform.localPosition = Vector3.zero;
        Material rockMaterial = LoadOrCreateRockMaterial();
        foreach (
            MeshRenderer ringRenderer in ringInstance.GetComponentsInChildren<MeshRenderer>(true)
        )
        {
            ringRenderer.sharedMaterial = rockMaterial;
            // Debris shouldn't cast the shared lights' shadows onto the planet -- reads as odd blobs.
            ringRenderer.shadowCastingMode = UnityEngine.Rendering.ShadowCastingMode.Off;
        }
        SetLayerRecursively(ringInstance, planetLayer);
    ...
    /// <summary>
    /// Sets the layer on a GameObject and every descendant.
    /// </summary>
    ...
    /// <summary>
    /// Scales the instance so its largest render-bounds extent maps to a diameter of ~2 (radius
    /// ~1), so the arbitrarily-scaled Meshy import frames consistently regardless of its native size.
    /// </summary>
    /// <param name="instance">The instantiated model to normalize in place.</param>
    private static void NormalizeToUnitDiameter(GameObject instance)
    {
        ...
        instance.transform.localScale *= 2f / maxExtent;
    }
    ...
    private static void InstallSpinning3DIcons(GameObject root)
    {
        ...
        for (int i = 0; i < _faces.Length; i++)
        {
            ...
            GameObject model = AssetDatabase.LoadAssetAtPath<GameObject>(face.ModelPath);
            if (model == null)
                throw new InvalidOperationException($"Model not imported at {face.ModelPath}.");
            ...
            BuildRig(iconRigs, model, renderTexture, face, i);
    ...
    /// <param name="model">The model prefab to instance.</param>
    /// <param name="renderTexture">The texture the rig camera renders into.</param>
    ...
    )
    {
        ...
        GameObject instance = UnityEngine.Object.Instantiate(model, pivot.transform);
        instance.name = "Model";
        instance.transform.localPosition = Vector3.zero;
        instance.transform.localScale *= face.ModelScale;
        // Explicit presentation pose (the FBX import orientation is not dependable): a coin is
        // rotated to face the camera; a ship is banked to its angle.
        instance.transform.localRotation = Quaternion.Euler(face.Tilt);
        CenterOnPivot(pivot.transform, instance);

        // Textured ship: build/apply a Standard PBR material from the maps.
        if (!string.IsNullOrEmpty(face.MaterialPath))
        {
            Material shipMaterial = LoadOrCreateShipMaterial(face);
            foreach (
                MeshRenderer meshRenderer in instance.GetComponentsInChildren<MeshRenderer>(true)
            )
            {
                Material[] mats = new Material[Mathf.Max(1, meshRenderer.sharedMaterials.Length)];
                for (int m = 0; m < mats.Length; m++)
    ...
    /// <summary>
    /// Offsets the model so its combined render bounds sit on the pivot origin, so it spins in
    /// place rather than orbiting the pivot.
    /// </summary>
    /// <param name="pivot">The transform the model rotates around.</param>
    /// <param name="model">The instantiated model to recenter.</param>
    private static void CenterOnPivot(Transform pivot, GameObject model)
    {
