...
//     /// <returns></returns>
//     public MoveUnitsAction CreateMoveUnitsAction(List<SceneNode> units, SceneNode target)
//     {
//         SerializableDictionary<string, object> params = new SerializableDictionary<string, object>
//         {
//             { "UnitInstanceIDs", units.Select(unit => unit.InstanceID).ToList() },
//             { "TargetInstanceID", target.InstanceID }
//         }
//         return new MoveUnitsAction(params);
//     }
// }