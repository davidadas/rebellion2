...
namespace Rebellion.Util.Common
{
    ...
    public static class GameLogger
    {
        ...
        /// silently dropped. Call with <see cref="LogLevel.Error"/> in test assemblies to
        /// suppress informational output from production code during test runs.
        /// </summary>
        ...
        /// <summary>
        /// Logs a debug-level message to the Unity Console and optionally to a file.
        /// </summary>
        /// <typeparam name="T">The type of the message to log.</typeparam>
        /// <param name="message">The message to log.</param>
