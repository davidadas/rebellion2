...
namespace Rebellion.AI.Proposals
{
    ...
    {
        /// <summary>Creates a claim for a fleet's order.</summary>
        ...
        /// <summary>Creates a claim for a fleet colonization order.</summary>
        /// <param name="fleetId">The fleet instance ID.</param>
        ...
        /// <summary>Creates a claim for an orbital engagement target.</summary>
        /// <param name="planetId">The target planet instance ID.</param>
        ...
        /// <summary>Creates a claim for transfers into a fleet.</summary>
        ...
        /// <summary>Creates a claim for satisfying fleet reinforcement demand.</summary>
        ...
        /// <summary>Creates a claim for forming a new fleet.</summary>
        ...
        /// <summary>Creates a claim for starting a faction offensive.</summary>
        ...
        /// <summary>Creates a claim for starting a faction colonization order.</summary>
        /// <param name="factionId">The faction instance ID.</param>
        ...
        /// <summary>Creates a claim for assigning a mission participant.</summary>
        ...
        /// <summary>Creates a claim for a faction research discipline.</summary>
        /// <param name="factionId">The faction instance ID.</param>
        ...
        /// <summary>Creates a claim for a mission targeting an officer.</summary>
        ...
        /// <summary>Creates a claim for a selected mission target.</summary>
        ...
        /// <summary>Creates a claim for a mission type at a planet.</summary>
        ...
        /// <summary>Creates a claim for satisfying production demand.</summary>
        ...
        /// <summary>Creates a claim for constructing a building at a planet.</summary>
        ...
        /// <summary>Creates a claim for replacing a building.</summary>
        ...
        /// <summary>Creates a claim for producing a building type.</summary>
        ...
        /// <summary>Creates a claim for a planet's building-production lane.</summary>
        ...
        /// <summary>Creates a claim for a planet's manufacturing lane.</summary>
