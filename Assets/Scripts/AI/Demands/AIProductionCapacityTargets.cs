...
{
    /// <summary>
    /// Calculates faction-wide production-facility capacity targets shared by expansion and retirement.
    /// </summary>
    internal static class AIProductionCapacityTargets
    {
        /// <summary>
        ...
        internal static int GetDesiredCount(AITurnContext context, BuildingType buildingType)
        {
