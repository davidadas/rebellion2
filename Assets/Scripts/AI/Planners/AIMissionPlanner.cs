    ...
    public sealed class AIMissionPlanner : IAIProposalPlanner
    {
        ...
        private double GetDiplomacyCandidatePriority(AITurnContext context, Planet planet)
        {
            ...
            if (context.Assessment.IsOwnedPlanet(planet))
            {
                ...
                score.Add(
                    AIUtility.Fulfillment(100 - support, utility.SupportDeficit),
                    utility.SupportDeficit
                );
                score.Add(
                    AIUtility.Fulfillment(supportRisk, utility.SectorSupportRisk),
            ...
            score.Add(
                AIUtility.Fulfillment(support, utility.SupportDeficit),
                utility.SupportDeficit
            );
            return score.Value;
        }
