...
/// <summary>
/// Merges a sparse content-pack override document over an application-level
/// defaults document.
/// </summary>
/// <remarks>
...
/// </remarks>
public static class ContentXmlMerger
{
    /// <summary>
    ...
    public static void ApplyOverrides(XmlDocument defaults, XmlDocument overrides)
    {
