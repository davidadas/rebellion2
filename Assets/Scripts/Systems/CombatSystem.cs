...
namespace Rebellion.Systems
{
    ...
    public class CombatSystem
    {
        ...
        /// <summary>
        /// Creates the combat system and its concrete encounter resolvers.
        /// </summary>
        /// <param name="game">The active game state.</param>
        /// <param name="provider">The random-number source used by combat resolution.</param>
        /// <param name="movement">The movement system used for fleet withdrawal.</param>
        /// <param name="ownership">The planetary-control system used by assaults.</param>
        public CombatSystem(
            GameRoot game,
        ...
        private PendingCombatResult BuildPendingCombatResult(CombatDecisionContext decision)
        {
            ...
            return new PendingCombatResult
            {
                ...
                AttackerCanRetreat = _spaceCombat.CanRetreatFleet(attacker, defender),
                DefenderCanRetreat = _spaceCombat.CanRetreatFleet(defender, attacker),
        ...
        )
        {
            ...
            if (!_spaceCombat.TryRetreatFleet(decision, retreatingFleetInstanceId))
                return false;
        ...
        public List<GameResult> ResolvePendingCombatRetreat(string retreatingFactionInstanceId)
        {
            if (_pendingDecision == null)
                throw new InvalidOperationException("No pending combat to resolve.");
    ...
    internal class SpaceCombatResolver
    {
        ...
        /// <summary>
        /// Resolves an encounter while allowing automatic pre-combat withdrawal.
        /// </summary>
        /// <param name="decision">The encounter context to resolve.</param>
        /// <returns>Combat results generated by the encounter.</returns>
        ...
        public bool CanRetreatFleet(Fleet fleet, Fleet opponent)
        {
    ...
    internal class PlanetaryAssaultResolver
    {
        ...
        public PlanetaryAssaultResult Execute(List<Fleet> attackingFleets, Planet defendingPlanet)
        {
            ...
            int totalAssaultStrength = GetTotalAssaultStrength(attackingFleets);
        ...
        /// <summary>
        /// Gets combined assault strength for the attacking fleets.
        /// </summary>
        /// <param name="attackingFleets">Fleets performing the assault.</param>
        /// <returns>Total assault strength.</returns>
        private int GetTotalAssaultStrength(List<Fleet> attackingFleets)
        {
        ...
        /// <summary>
        /// Applies capital strike damage against production facilities, units, and energy.
        /// </summary>
        /// <param name="planet">The planet being assaulted.</param>
        /// <param name="excessAssaultStrength">The assault strength above defense.</param>
        ...
        /// <param name="result">The assault result to mutate.</param>
        ...
        )
        {
            ...
            TryExecuteInitialProductionStrike(planet, thresholdLow, thresholdHigh, result);
            ExecuteAssaultStrikeLoop(
                planet,
                excessAssaultStrength,
                energyResistance,
                allocatedEnergyResistance,
        ...
        /// <summary>
        /// Attempts the initial production-facility strike for an assault.
        /// </summary>
        /// <param name="planet">The planet being assaulted.</param>
        /// <param name="thresholdLow">The lower strike roll bound.</param>
        /// <param name="thresholdHigh">The upper strike roll bound.</param>
        /// <param name="result">The assault result to mutate.</param>
        private void TryExecuteInitialProductionStrike(
            Planet planet,
            int thresholdLow,
            int thresholdHigh,
            PlanetaryAssaultResult result
        )
        {
            ...
            Building target = productionBuildings[_provider.NextInt(0, productionBuildings.Count)];
        ...
        /// <summary>
        /// Runs the capital-strike loop for excess assault strength.
        /// </summary>
        /// <param name="planet">The planet being assaulted.</param>
        /// <param name="excessAssaultStrength">The assault strength above defense.</param>
        /// <param name="energyResistance">Resistance value for the energy lane.</param>
        ...
        /// <param name="thresholdHigh">The upper strike roll bound.</param>
        /// <param name="result">The assault result to mutate.</param>
        private void ExecuteAssaultStrikeLoop(
            Planet planet,
            int excessAssaultStrength,
            int energyResistance,
            int allocatedEnergyResistance,
        ...
        /// <summary>
        /// Returns true when a building is a defense facility.
        /// </summary>
        /// <param name="building">Building to classify.</param>
        /// <returns>True if the building is a defense facility.</returns>
        ...
        /// <summary>
        /// Returns true when a building is a production target in assault lane ordering.
        /// </summary>
        /// <param name="building">Building to classify.</param>
        /// <returns>True if the building is a production target.</returns>
        ...
        {
            Faction attackerFaction = _game.GetFactionByOwnerInstanceID(attackerFactionId);
            return attackerFaction == null
                ? 0
        ...
        /// <summary>
        /// Counts regiments currently embarked on the attacking fleets.
        /// </summary>
        /// <param name="attackingFleets">Fleets performing the assault.</param>
        /// <returns>The number of embarked regiments.</returns>
        ...
        /// <summary>
        /// Lands embarked regiments onto a captured planet up to the required garrison.
        /// </summary>
        /// <param name="attackingFleets">Fleets carrying assault regiments.</param>
        /// <param name="planet">The captured planet.</param>
        /// <param name="requiredGarrison">Number of regiments to land.</param>
    ...
    internal class PlanetaryDefenseCombatResolver
    {
        ...
        private bool Stage5_GarrisonTroopResolution(DefenseRun run)
        {
            ...
            Faction defenderFaction = _game.GetFactionByOwnerInstanceID(
                run.Planet.GetOwnerInstanceID()
            );
            run.GarrisonRequirement =
        ...
        /// <summary>
        /// Finds the first non-defender faction among the fleets.
        /// </summary>
        /// <param name="fleets">Fleets involved in the combat.</param>
        /// <param name="defenderOwnerId">The defender owner instance ID.</param>
        /// <returns>The attacking faction instance ID, or null.</returns>
        ...
        /// <summary>
        /// Counts regiments carried by hostile capital ships orbiting the planet.
        /// </summary>
        /// <param name="fleets">Fleets orbiting the planet.</param>
        /// <param name="defendingOwnerId">The defending faction owner instance ID.</param>
        /// <returns>The number of attacking regiments carried by orbiting ships.</returns>
        ...
        /// <summary>
        /// Rolls a percentage success check.
        /// </summary>
        /// <param name="successesPerHundred">Success chance out of one hundred.</param>
        ...
        /// <summary>
        /// Counts successful repeat trials at the configured repeat probability.
        /// </summary>
        /// <param name="trialCount">The number of trials to roll.</param>
        ...
        /// <summary>
        /// Selects the next repeat-damage strike target.
        /// </summary>
