...
namespace Rebellion.Systems
{
    ...
    public class SpaceCombatSystem
    {
        ...
        /// </summary>
        public bool HasPendingDecision => _game.PendingSpaceCombat != null;
        ...
        {
            result =
                _game.PendingSpaceCombat == null
                    ? null
                    : BuildPendingCombatResult(_game.PendingSpaceCombat);
            return result != null;
        }
        ...
        public List<GameResult> ProcessTick()
        {
            ...
            if (_game.PendingSpaceCombat != null)
                return results;
            ...
            while (TryBeginFleetCombat(resolvedFleetIds, out SpaceCombatDecision decision))
            {
                ...
                _game.PendingSpaceCombat = decision;
        ...
        public List<GameResult> ResolvePending(bool autoResolve)
        {
            ...
            SpaceCombatDecision decision = _game.PendingSpaceCombat;
        ...
        public List<GameResult> ResolvePendingTactical(TacticalBattleSession session)
        {
            ...
            if (_game.PendingSpaceCombat == null)
                throw new InvalidOperationException("No pending combat to resolve.");
            if (!MatchesPendingDecision(session.Encounter, _game.PendingSpaceCombat))
        ...
        public List<GameResult> ResolvePendingRetreat(string retreatingFactionInstanceId)
        {
            ...
            Fleet attacker = _game.GetSceneNodeByInstanceID<Fleet>(
                _game.PendingSpaceCombat.AttackerFleetInstanceID
            );
            Fleet defender = _game.GetSceneNodeByInstanceID<Fleet>(
                _game.PendingSpaceCombat.DefenderFleetInstanceID
            );
