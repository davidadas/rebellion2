...
public sealed class GarrisonPane : MonoBehaviour
{
    ...
    private void UpdateTabStates()
    {
        ...
        shieldsButton.interactable = planet.GetBuildingTypeCount(BuildingType.Defense) > 0;

        weaponsButton.interactable = planet.GetBuildingTypeCount(BuildingType.Weapon) > 0;
    }
}
