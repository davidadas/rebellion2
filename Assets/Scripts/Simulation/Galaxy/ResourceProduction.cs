...
namespace Rebellion.Simulation
{
    ...
    /// </summary>
    internal class ResourceProduction
    {
        private const int _percentScale = 100;

        private readonly GameRoot _game;
        private readonly Smuggling _smugglingSystem;

        /// <summary>
        /// Creates a new ResourceProduction.
        /// </summary>
        /// <param name="game">The game instance.</param>
        public ResourceProduction(GameRoot game)
        {
            _game = game ?? throw new ArgumentNullException(nameof(game));
            _smugglingSystem = new Smuggling(game);
        }
