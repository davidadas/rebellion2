...
namespace Rebellion.Simulation
{
            ...
            IGameResultHandler<OfficerCaptureStateResult>
    {
        ...
        private readonly Movement _movementManager;
        private readonly Uprisings _uprisingSystem;
        private readonly OfficerLoyalty _officerLoyaltySystem;
        private readonly Personnel _personnelSystem;
        ...
        public Missions(
            ...
            Uprisings uprisingSystem,
            OfficerLoyalty officerLoyaltySystem = null,
            Personnel personnelSystem = null
        )
        {
            _game = game;
            _provider = provider;
            ...
            _officerLoyaltySystem = officerLoyaltySystem ?? new OfficerLoyalty(game, provider);
            _personnelSystem = personnelSystem ?? new Personnel(game);
