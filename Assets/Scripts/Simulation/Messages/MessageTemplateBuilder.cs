...
{
    /// <summary>
    /// Resolves configured templates into message content and delivery metadata.
    /// </summary>
    internal sealed class MessageTemplateBuilder
    {
        ...
        /// <summary>
        /// Resolves a message definition and template values into prepared message content.
        /// </summary>
        ...
        )
        {
            ...
            {
                Recipient = faction,
                Message = new StatusMessage(definition.MessageType, title, body)
                {
