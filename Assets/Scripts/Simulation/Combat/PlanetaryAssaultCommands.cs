...
namespace Rebellion.Simulation
{
    ...
    public class PlanetaryAssaultCommands
    {
        ...
        /// <summary>
        /// Creates the planetary-assault execution commands.
        /// </summary>
        ...
        /// <param name="ownership">The planetary control commands used to capture planets.</param>
        /// <param name="queries">The assault eligibility rules.</param>
        public PlanetaryAssaultCommands(
            GameRoot game,
            IRandomNumberProvider provider,
            PlanetaryControlCommands ownership,
            PlanetaryAssaultQueries queries
        )
        {
        ...
        )
        {
            ...
            if (!_queries.CanExecute(fleets, targetPlanet))
                return null;
        ...
        public PlanetaryAssaultResult Execute(List<Fleet> attackingFleets, Planet defendingPlanet)
        {
            ...
            if (!PlanetaryAssaultQueries.CanAssault(attackingFleets, defendingPlanet))
                return result;
