...
namespace Rebellion.Simulation
{
    ...
    /// </summary>
    internal sealed class FactionAutomation
    {
        private readonly GameRoot _game;
        private readonly GameDataCatalog _gameData;
        private readonly Manufacturing _manufacturing;
        ...
        {
            int required = Uprisings.CalculateGarrisonRequirement(
                planet,
                faction,
