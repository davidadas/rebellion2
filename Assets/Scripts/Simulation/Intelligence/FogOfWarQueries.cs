...
{
    /// <summary>
    /// Projects the galaxy and evaluates visibility using a faction's permitted information.
    /// </summary>
    public class FogOfWarQueries
    {
        private readonly GameRoot _game;

        /// <summary>
        /// Creates visibility queries for the game.
        /// </summary>
        /// <param name="game">The authoritative game supplying the view.</param>
        public FogOfWarQueries(GameRoot game)
        {
            _game = game;
        }
